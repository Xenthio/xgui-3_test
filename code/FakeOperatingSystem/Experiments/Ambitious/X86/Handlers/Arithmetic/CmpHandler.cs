...
public class CmpHandler : IInstructionHandler
{
    ...
    public void Execute(X86Core core)
    {
        ...
        if (opcode == 0x39) // CMP r/m32, r32
        {
            ...
            {
                // Not implementing memory operands in this basic version
                throw new NotImplementedException("Memory operands not implemented for CMP");
            }
        }
        else // CMP r32, r/m32
        {
        ...
        // Advance EIP
        core.Registers["eip"] += 2; // Simple case: no memory operands
    }
